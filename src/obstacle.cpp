...
Vec3f Obstacle::get_exerted_proximity_force(const MovingObject &object) const
{
    ...
    // std::cout << "obstacle " << obstacle_factor_ * diff.normalized() * (1.0 / dist - 1.0 / rad_max_) << " end ";
